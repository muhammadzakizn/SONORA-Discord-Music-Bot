...
const translations: Record<Language, Record<string, string>> = {
    en: {
        ...
        'profile.cannotChange': 'Synced from Discord, cannot be changed',
        ...
        'profile.noServers': 'You are not managing any servers',
        'profile.dangerZone': 'Danger Zone',
        'profile.logoutWarning': 'Logging out will end your session. You will need to sign in again with Discord.',
    ...
    id: {
        ...
        'profile.discord': 'Discord',
        'profile.discordId': 'ID Discord',
        'profile.discordUsername': 'Username Discord',
        'profile.discordInfo': 'Akun Discord',
        'profile.accountInfo': 'Informasi Akun',
        'profile.accountType': 'Tipe Akun',
        'profile.cannotChange': 'Disinkronkan dari Discord, tidak dapat diubah',
        ...
        'profile.noServers': 'Anda tidak mengelola server apapun',
        'profile.dangerZone': 'Zona Bahaya',
        'profile.logoutWarning': 'Keluar akan mengakhiri sesi Anda. Anda perlu masuk lagi dengan Discord.',
        'profile.logout': 'Keluar',
        'profile.logoutAll': 'Keluar dari semua perangkat',
        'profile.saved': 'Perubahan berhasil disimpan',
