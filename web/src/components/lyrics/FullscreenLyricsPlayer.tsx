                        ...
                        {((trackEnded || !track) && queue.length === 0 && !isTransitioning && !lyricsLoading) && (
                            ...
                            >
                                <div className="text-center px-8">
                                    ...
                                    <button
                                        onClick={onClose}
                                        className="px-8 py-3 bg-white/10 hover:bg-white/20 rounded-full text-white font-medium transition-all hover:scale-105"
                                    >
                                        Close Player
                                    </button>
                                </div>
                            ...
                            <div className="sm:hidden flex flex-col h-full">
                                {showLyrics ? (
                                    <>
                                        ...
                                        <div className="shrink-0 px-6 pt-14 pb-2">
