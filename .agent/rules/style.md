...
2. Pastikan selalu mengupdate changelog di :
 - Folder docs/changelog/bot untuk update sistem bot (Kamu cukup edit dan tambahkan update di bawahnya)
 - Folder docs/changelog/web untuk update WEB (Kamu cukup edit dan tambahkan update di bawahnya)
- Folder docs/changelog/overallversion untuk rangkuman dan seluruh update (Kamu cukup edit dan tambahkan update di bawahnya)
