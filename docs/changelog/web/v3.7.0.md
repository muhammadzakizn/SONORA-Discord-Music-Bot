...
- **Console** - Connected to real `/api/admin/logs` with polling
- **Messaging** - Connected to real `/api/admin/broadcast`
- **Controls** - Connected to real `/api/admin/shutdown`
- **Profile Settings** - Added link in developer dropdown menu
