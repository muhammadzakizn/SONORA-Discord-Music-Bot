...
## 📨 Broadcast Messaging Overhaul (December 13, 2025)
...
- Displays permission status (✓ Can Send / ✗ No Permission)
...
## 📝 Dynamic Changelog Management (December 13, 2025)
...
## 📨 Messaging Improvements (December 13, 2025)

### Multi-Select Dialog for Servers & Channels
- Replaced dropdown with fullscreen dialog
- Multiple servers can be selected with checkboxes
- Multiple channels can be selected from selected servers
- "Select All Sendable" button for quick selection
- Same for DM Users - multi-select with search

### Image File Upload
- Replaced URL input with file upload button
- Supports JPG, JPEG, PNG, GIF (max 8MB)
- Large image preview before sending
